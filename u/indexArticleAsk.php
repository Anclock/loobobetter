<div class="clearfix" id="homeMain">
        ...
        <div class="homeListBox">
                <div class="auditTabs">
                    <a class="" href="<?php bloginfo('url'); ?>/u/<?php echo $current_user->user_login;?>?u=article">文章</a><a class="current" href="<?php bloginfo('url'); ?>/u/<?php echo $current_user->user_login;?>?u=article&n=ask">问题</a>
                </div>
