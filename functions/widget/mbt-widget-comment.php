...
class widget_ui_comments extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo '<ul>';
		echo mode_newcomments( $limit,$outpost,$outer );
		echo '</ul>';
		echo $after_widget;
	}
